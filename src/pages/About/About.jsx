...
const About = () => {
    return (
        <main className="about-container">
            <h2>About</h2>
            <img className="about-container__img" src="https://res.cloudinary.com/dfbuwtl5q/image/upload/v1709347743/jackie-martin-2_uiou95.png" alt="Jackie Martin" />
            ...
            <p className="about-container__bio"> Jackie's love for audio stands out, as she has a sharp ear for content that resonates with audiences, making her an expert at producing shows that engage and entertain. <a className="about-container__highlight" href="https://www.wnyc.org/people/jacklyn-martin/" target="_blank">Her significant role as a line producer</a> for the Takeaway (WNYC) for three years highlights her ability to handle live production with finesse, tackling subjects that matter and make a difference, especially her impactful work on stories about LGBTQ+ veterans. </p>
            <p className="about-container__bio">   Starting her career in radio after her service in the Air Force, Jackie worked with notable names like Howard Stern, contributed to SiriusXM sports channels, and Fox News Radio, further solidifying her expertise and love for audio media. </p >
